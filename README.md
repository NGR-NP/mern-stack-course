...
4. The `PersistGate` component is used to persist the state of the store to local storage, and the App component is passed as the child to the rendered with the `PersistGate`. 
